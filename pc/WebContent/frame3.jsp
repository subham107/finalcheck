...
<frameset rows="20%,80%">
 <frame src="head.jsp" frameborder="0"    scrolling="no" noresize="noresize">
<frameset cols="20%,80%">
 ...
 <frame src="user.jsp" scrolling="yes" frameborder="0" style="padding-right: 30px; padding-bottom: 40px;" >
</frameset>
</frameset>
